/*
	...
	Version 2:
		...
		(7/07/2023) Optional bitsize of search "hash bucket" search list BITS = 1..12, default = 10.");
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void usage( void )
{
	...
	fprintf(stderr, "\n       M = bitsize of hash bucket search list (M = 1..12) default=10.");
	copyright();
	exit (0);
}
