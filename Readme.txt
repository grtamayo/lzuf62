...
(1)  lzuf62.c and lzufd62.c [works on bigger files];
(2)  lzuf621.c [optional sliding window size];
(3)  lzuf622.c [single file coder/decoder, with optional hash bucket search list size]:
